...
* To enable all features of DTrace on macOS Sierra, boot into recovery mode and [disable SIP]({% capture itemLink %}{% include findCollectionItem.html collectionName='tips' itemTitle='Enable/Disable Rootless Mode' %}{% endcapture %}{{ itemLink | strip_newlines }}), or enable with dtrace:
