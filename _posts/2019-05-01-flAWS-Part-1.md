...
<div class="box-note">
The CLI command <a href="https://docs.aws.amazon.com/cli/latest/reference/s3/ls.html">ls</a> lists S3 objects and common prefixes under a prefix or <i><b>all S3 buckets</i></b>.
</div>
