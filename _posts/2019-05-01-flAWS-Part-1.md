...
AWS Access Key ID [None]: AKIA3AKEDCLXAG6POBIT
AWS Secret Access Key [None]: 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
...
<div class="box-note">
The CLI command <a href="https://docs.aws.amazon.com/cli/latest/reference/s3/ls.html">ls</a> lists S3 objects and common prefixes under a prefix or <i><b>new and updated files</b></i>
</div>
...
AWS Access Key ID [None]: AKIAJ366LIPB4IJKT
AWS Secret Access Key [None]: OdNa7m+bqUvF3Bn/qgSnPE1kBpqcBTTjqwP
Default region name [None]:
Default output format [None]:
```
