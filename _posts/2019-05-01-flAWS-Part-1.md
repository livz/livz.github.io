...
<div class="box-note">
Note that setting the correct permissions for the user is very important. The new user would need at least *Read* permissions in order to read other buckets! To be sure, set it to <b>AmazonS3FullAccess</b>. The logic of evaluating permissions for bucket operations is described <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-auth-workflow-bucket-operation.html#example4-policy-eval-logic">here</a>
</div>
