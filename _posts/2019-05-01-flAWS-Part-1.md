...
<blockquote>
For the next level, you need to get access to the web page running on an EC2 at <a href="4d0cf09b9b2d761a7d87be99d17507bce8b86f3b.flaws.cloud">4d0cf09b9b2d761a7d87be99d17507bce8b86f3b.flaws.cloud</a>. <br/>
...
<div class="box-warning">
  Tot avoid the <i><b>snapshotId can only be modified on EBS devices</i></b> error when attaching the volume, search by snapshot id (<i>snap-0b49342abd1bdcb89</i>) and use an available AWS recommended device name like <code>/dev/sdf</code>.  AWS recommended device names for attaching EBS volumes are <code>/dev/sd[f-p]</code>
</div>
